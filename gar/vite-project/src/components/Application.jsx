...
export default function Application() {
    ...
    const {isLoading, error, refetch} = useQuery('summary-data',fetchData,{
            enabled: false,
            onSuccess: (data) => {
                setData(data);
            }
    ...
    return <div className="flex flex-col w-screen h-screen bg-blue-100">
        ...
        <div className="flex items-center justify-center w-full h-full bg-gray-400 gap-3">
            ...
            <SummaryComp className="w-3/6 h-4/6  rounded-xl flex flex-col px-8 py-10 bg-gray-100 " isLoading = {isLoading} data={data}/>
