...
export default function Application({client}) {
    ...
    return <div className="flex flex-col w-screen h-screen bg-blue-100">
        <AppHeader className="flex justify-center items-center h-20 w-full bg-sky-800" />
        ...
        <div className="flex items-center justify-center w-full h-full bg-gray-400 gap-3">
            ...
            <SummaryComp className="w-3/6 h-4/6  rounded-xl flex flex-col" isLoading = {isLoading} data={data} setData = {setData} fetchStatus={fetchStatus} queryClient={client}/>
